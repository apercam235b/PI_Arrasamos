...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Captura una imagen desde la cámara y la guarda en la ruta especificada.')
    parser.add_argument('ruta', type=str, help='La ruta donde se guardará la imagen capturada.')
